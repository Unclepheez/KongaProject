...
public void successfulLogin() throws InterruptedException {
        ...
        driver.findElement(By.id("username")).sendKeys("hafizadeniyi@yahoo.com");
        //6. Input Your password in the password field
        driver.findElement(By.id("password")).sendKeys("alogba01");
        Thread.sleep(2000);
